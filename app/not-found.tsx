...
export default function NotFound ()  {
  return (
    <div className='flex justify-center mt-4 items-center flex-col w-full mx-auto text-center gap-2 px-6'>
      ...
      <Image
          ...
          />
      <div className='my-8'>
        <h2 className='text-lg text-center font-bold leading-[1.15] lg:text-2xl pt-6 pb-2'> Need further assistance?</h2>
