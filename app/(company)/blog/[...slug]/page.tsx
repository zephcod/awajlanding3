...
import { Mdx } from "@/components/mdx/mdx_components"
...
import { absoluteUrl, cn, formatDate } from "@/app/utils/utils"
...
export default async function PostPage({ params }: PostPageProps) {
  ...
  return (
    <Shell as="article" variant="markdown" className="mt-14 p-4 container">
      <Link
        href="/blog"
        className={cn(
