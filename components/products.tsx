...
import { cn, toTitleCase } from "@/app/utils/utils"
    ...
    <div className="flex flex-col space-y-6">
      <div className="flex items-center space-x-2">
        <Sheet>
          <SheetTrigger asChild>
            <Button aria-label="Filter products" variant='outline' size="sm" disabled={isPending}>
              Filter
            </Button>
          </SheetTrigger>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button aria-label="Sort products" variant="outline" size="sm" disabled={isPending}>
              Sort
      ...
      {!isPending && !products.length ? (
        <div className="mx-auto flex max-w-xs flex-col space-y-1.5">
          <h1 className="text-center text-2xl font-bold">No solutions found</h1>
          <p className="text-center text-muted-foreground">
            Try changing your filters, or check back later for new solutions
          </p>
        </div>
      ) : null}
